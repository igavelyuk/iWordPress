...
$(function() {
  ...
  //   sectionsItems(data.drinksarray, 2, "rounded-border-image-blue");
    ...
    //-------------------------------------------------
    var firebaseConfig = {
    apiKey: "AIzaSyD5aR1LuWus0ETUgnSJb8OnS-bXZFtWImU",
    authDomain: "sushipandabc.firebaseapp.com",
    databaseURL: "https://sushipandabc.firebaseio.com",
    projectId: "sushipandabc",
    storageBucket: "sushipandabc.appspot.com",
    messagingSenderId: "502329418559",
    appId: "1:502329418559:web:66f4231abd07a4e944a98a",
    measurementId: "G-EZGNWN01Y4"
  };
  // Initialize Firebase
    ...
    dbRef.on('value',function(datax){
      var data = datax.val();
      console.log(data);
        sectionsItems(data.sushisarray, 0, "rounded-border-image");
        sectionsItems(data.sushisetsarray, 1, "rounded-border-image-orange");
...
function addToChart(itemObject) {
  ...
  if(bonus>300&&totalPrice.length>1){
    if(!bonusApply){
